...
REPOSITORY_URL = 'git@github.com:thetylerloop/%s.git' % REPOSITORY_NAME
...
PRODUCTION_S3_BUCKET = {
    'bucket_name': 'data.thetylerloop.com',
    'region': 'us-east-1'
}

STAGING_S3_BUCKET = {
    'bucket_name': 'stage-data.thetylerloop.com',
    'region': 'us-east-1'
}

ASSETS_S3_BUCKET = {
    'bucket_name': 'assets.thetylerloop.com',
    'region': 'us-east-1'
}
